...
class Numbermanager{
	...
	public synchronized void printEvenNumbers() throws InterruptedException {
		while(!numberGenerated || generatedNumber %2!=0) {
			...
			System.out.println("square of generated even number is:"+generatedNumber*generatedNumber);
	...
	public synchronized void printOddNumbers() throws InterruptedException {
		...
		System.out.println("cube of generated odd number is:"+generatedNumber*generatedNumber*generatedNumber);
